...
@Injectable()
export class IntelxJsonParser implements Parser {
  readonly name = 'intelx-json';
  ...
  async parse(input: Buffer | string, ctx: ParserContext): Promise<NormalizedOutput> {
    ...
    for (const entry of exposures) {
      const row = entry as IntelxExposureRow;
